...
let blueProducts = saleProducts.filter(elem => elem.color.includes('blue'))
...
let person = {
  name: 'Davis',
  age: 26,
  jobs: ['Plant Optimization Engineer', 'Reliability Testing Intern', 'Mechanical Engineering Intern'],
  birthday: function() {
    this.age += 1
  },
  favorites: {
